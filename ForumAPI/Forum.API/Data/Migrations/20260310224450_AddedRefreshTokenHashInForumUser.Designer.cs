...
namespace Forum.API.Migrations
{
    ...
    [Migration("20260310224450_AddedRefreshTokenHashInForumUser")]
    partial class AddedRefreshTokenHashInForumUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forum.API.Entities.ForumMember", b =>
                {
                    b.HasOne("Forum.API.Entities.ForumUser", "User")
                        .WithOne("Member")
                        .HasForeignKey("Forum.API.Entities.ForumMember", "Id")
            ...
            modelBuilder.Entity("Forum.API.Entities.Post", b =>
                {
                    b.HasOne("Forum.API.Entities.ForumMember", "Member")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Forum.API.Entities.Reply", b =>
                {
                    ...
                    b.HasOne("Forum.API.Entities.Post", "Post")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Forum.API.Entities.ForumUser", null)
                        .WithMany()
